...
export function buildCertificateHtml(input: { name: string; downloadedDate: string; certificateId: string; logoSrc: string }) {
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* ── Footer row (3-column grid: meta | signature | seal) ── */
  .footer {
    width: 100%;
    max-width: 100%;
    display: grid;
    grid-template-columns: minmax(0, 1fr) minmax(200px, 1.15fr) minmax(0, 1fr);
    align-items: end;
